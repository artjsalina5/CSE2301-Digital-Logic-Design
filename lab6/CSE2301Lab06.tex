...
\subsubsection*{ALU Circuit Elongation}
...
\begin{itemize}
	...
	\item \textbf{Outputs:}
	      \begin{itemize}
		      \item \( QA, QB, QC, QD \): Outputs the result of either the AND or OR operations based on the \( SEL \) line.
	      \end{itemize}
\end{itemize}
...
\begin{examp}
	...
	% Insert binary multiplication steps here as needed.
\end{examp}
\end{document}
